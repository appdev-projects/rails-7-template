...
puts "There are now #{Brand.count} brands."
puts "There are now #{Department.count} departments."
puts "There are now #{Role.count} roles."
puts "There are now #{Shop.count} shops."
puts "There are now #{Product.count} products."
puts "There are now #{Tester.count} testers."
